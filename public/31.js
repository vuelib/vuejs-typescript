...
/* harmony import */ var _common_formButton_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../common/formButton.vue */ "./resources/js/components/common/formButton.vue");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var tableOrderList = /** @class */ (function (_super) {
    ...
    Object.defineProperty(tableOrderList.prototype, "order", {
        get: function () {
    ...
    Object.defineProperty(tableOrderList.prototype, "columns", {
        get: function () {
            var columns = [
            ...
            if (this.order.status !== "potvrzena") {
                return __spreadArrays(columns, [{ key: "", label: "Možnosti" }]);
            }
            return columns;
        },
        enumerable: false,
    ...
    tableOrderList = __decorate([
        Object(vue_property_decorator__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            components: {
                ...
                formButton: _common_formButton_vue__WEBPACK_IMPORTED_MODULE_2__["default"],
            },
        })
    ], tableOrderList);
