<template>
  <div class="md:flex">
    <aside class="sidebar">
      ...
      <div class="menu">
        <input
          ...
          v-model="search"
        />
        <div class="link hidden md:block" v-on:click="allProduct">Všechny produkty</div>
        <div v-bind:key="category.id" v-for="category in categories">
          <div
    ...
    <div>
      <div class="mt-3 p-3">
        <h3>{{ all ? "Všechny produkty" : categoryName }}</h3>
      </div>
      <div
        ...
        <div class="flex flex-col p-2">
          ...
          <div v-bind:key="product.id" v-for="product in products" v-show="!collapsed">
            <div v-bind:key="(index)" v-for="(value, index) in orders.order">
              <div class="flex text-center" v-if="index == product.id">
      ...
      <form @submit.prevent="addOrder">
        <button class="success" type="submit">Potvrdit</button>
        <div class="table mt-3">
          <div class="flex flex-wrap">
            <table class="table-fixed">
              <thead>
                <tr>
                  <th class="w-1/2 px-4 py-2">Název produktu</th>
