<template>
  <div>
    <div class="max-w-3xl flex flex-wrap p-6">
      <!--Main Col-->
      <div
        class="w-full lg:w-full rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-ivory mx-6 lg:mx-0"
        id="profile"
      >
        <div class="p-4 md:p-12 text-center lg:text-left">
          <!-- Image for mobile view-->
          <div
            class="block lg:hidden rounded-full shadow-xl mx-auto -mt-6 h-48 w-48 bg-cover bg-center"
            style="background-image: url('https://www.prteconline.com/home2/wp-content/uploads/2018/09/AAE78F1E-39A5-41C4-9AAA-8EE91232AAFE.jpeg')"
          ></div>
